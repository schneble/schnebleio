...
<Button className='bg-zinc-100 border mb-1 flex text-center items-center rounded  ' >
                    <Link href="https://github.com/j-schneble/jsKeys">
                        <GithubIcon size={24} className='text-zinc-700  ' />
                    </Link>
                </Button>
2 JSON complex modifications
            ...
            <p className={subtitle({
                ...
                Arrow Keys Modification <span className='font-light'> -- When holding down caps-lock, letter keys j, k, l, and i become arrow keys j←, k↓, l→, and i↑. </span>
            </p>
            <p className={subtitle({
