...
<div className=" px-6 shadow-lg antialiased items-center text-left justify-evenly  max-w-2xl flex flex-col ">
    <div className='flex flex-row gap-4 justify-evenly'>


<Button color="primary" className='bg-black text-white rounded-md border-2 border-zinc-300' as={Link}href='https://github.com/j-schneble/all-View'>
                    ...
                    <Button className='bg-black text-white rounded-md border-2 border-zinc-300' color="primary" as={Link} href='https://main.d103fh40oxa2yj.amplifyapp.com'>
...
<h1 className={subtitle({ class: " border-b-2 border-slate-100 py-1 pb-2 mt-4 font-medium rounded-sm   px-2 flex flex-col" })}>
 Overview
</h1>
...
to improve efficiency in resource management. </h2>
<h2 className={subtitle({ class: " border-b-2 border-slate-100 py-1 pb-2 mt-4 font-medium rounded-sm   px-2 flex flex-col" })}>
 Key Features
</h2>
...
Git configuration, and environment variable setup. This process ensured that the application environment was fully prepared for production deployment.
    </li>
    <h2 className='font-medium  mt-2 mb-2 text-lg px-2 antialiased backdrop-blur-sm py-2'>
...
<ul className='p-1'>
<li className='bg-slate-50/10 antialiased backdrop-blur-sm p-2 rounded-sm'>
Leveraging AWS architecture diagrams to visualize service connections, simplifying complex interactions and enhancing system manageability were crucial for gaining a deeper understanding of AWS services.
</li>
</ul>
